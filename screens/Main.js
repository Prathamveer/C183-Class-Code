                ...
                <View style={styles.framesContainer}>
                    <View style = {styles.categoryContainer}>
                        <TouchableOpacity style = {
                            ...
                            <TouchableOpacity style = {this.state.selected = "rimless" ? 
                            styles.categoryBoxSelected : styles.categoryBox} onPress= {()=> this.setState({selected : `rimless`})}>
                                <Text>Rimless</Text>
                            </TouchableOpacity>

                            <TouchableOpacity style = {this.state.selected = "round" ? 
                            styles.categoryBoxSelected : styles.categoryBox} onPress = {()=> this.setState({selected : `round`})}>
                                <Text>Round</Text>
                            </TouchableOpacity>
